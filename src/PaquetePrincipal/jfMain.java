...
public class jfMain extends javax.swing.JFrame {
  ...
  private void crear_Tipos(Connection conn) throws SQLException {
    ...
    //indicaciones dadas
    String vivienda = "CREATE TYPE vivienda AS("
            + "planta integer, "
            + "metros_2 integer, "
    ...
    String direccion = "CREATE TYPE direccion AS("
            + "calle varchar(40), "
            + "ciudad varchar(25), "
    ...
    String func_publicidad = "CREATE FUNCTION func_publicidad(vivienda) RETURNS varchar AS "
            + "$$SELECT 'Ubicado en '||CAST($1.planta AS varchar)||'º planta, con '"
            + "||CAST($1.metros_2 AS varchar)||' metros cuadrados, '"
            + "||CAST($1.num_habitaciones AS varchar)||' habitaciones y '"
            + "||CAST($1.num_bannios AS varchar)||' baño/s'$$ LANGUAGE SQL";
    ...
    //ejecuta la consulta
    sta.execute(vivienda);
    sta.execute(direccion);
    sta.execute(func_publicidad);
    //cierra el objeto auxiliar
    sta.close();
  }
  ...
  private void crear_Tabla(Connection conn) throws SQLException {
    ...
    String consulta = "CREATE TABLE viviendas_alquiler("
  ...
  private void insertar_Registros(Connection conn) throws SQLException {
    ...
    String consulta = "INSERT INTO viviendas_alquiler(caracteristicas, ubicacion) VALUES("
            + "ROW(1,90,3,2,'David Jiménez'), ROW('Rellenadora', 'Dos Hermanas', 'Sevilla', '41701'));"
            + "INSERT INTO viviendas_alquiler(caracteristicas, ubicacion) VALUES("
            + "ROW(3,65,2,1,'David Jiménez'), ROW('Batalla de San Quintin', 'Dos Hermanas', 'Sevilla', '41701'));"
            + "INSERT INTO viviendas_alquiler(caracteristicas, ubicacion) VALUES("
            + "ROW(1,120,3,1,'Valme Cotán'), ROW('Toneleros', 'Sevilla', 'Sevilla', '41701'))";
    //+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
  ...
  private void rellenar_JComboBox(Connection conn) throws SQLException {
    ...
    String consulta = "SELECT DISTINCT (ubicacion).ciudad FROM viviendas_alquiler";
    //++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
  ...
  private void rellenar_JTable(Connection conn, Object ciudad) 
    ...
    if (ciudad != null) {
      ...
      String nombre_ciudad = (String)ciudad;  
      //+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
      ...
      String consulta = "SELECT * FROM viviendas_alquiler WHERE (ubicacion).ciudad='"+nombre_ciudad+"'";
      //+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
  ...
  private void mensajePublicitario(Object viviendaId) throws SQLException {
    ...
    try {
      ...
      String consulta = String.format(
              "SELECT func_publicidad(caracteristicas) FROM viviendas_alquiler "
